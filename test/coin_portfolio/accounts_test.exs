defmodule CoinPortfolio.AccountsTest do
  ...
  describe "users" do
    ...
    test "create_user/1 with valid data creates a user" do
      ...
      assert user.cmc_api_key == "some cmc_api_key"
      assert user.email == "some email"
      assert user.first_name == "some first_name"
      assert user.last_name == "some last_name"
      assert user.main_currency == "some main_currency"
    ...
    test "update_user/2 with valid data updates the user" do
      ...
      assert user.cmc_api_key == "some updated cmc_api_key"
      assert user.email == "some updated email"
      assert user.first_name == "some updated first_name"
      assert user.last_name == "some updated last_name"
      assert user.main_currency == "some updated main_currency"
  ...
  import CoinPortfolio.AccountsFixtures
  alias CoinPortfolio.Accounts.{User, UserToken}
